// Test posting your book data to port 3001
console.log('📚 Testing your book data on port 3001...');
...
async function testYourBook() {
  try {
    ...
    console.log('📋 Posting book to port 3001:', bookData.Title);
