...
async function testAdminAuth() {
  ...
  try {
    ...
    console.log('\n9. Testing Get Audit Logs for Specific Admin...');
    ...
    console.log('\n10. Testing Delete Admin Protection...');
    try {
